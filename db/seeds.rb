...
# Create Tags
Tag.create(article_id: 1, category_id: 1, category_name: 'longboarding')
Tag.create(article_id: 2, category_id: 3, category_name: 'freediving')
Tag.create(article_id: 3, category_id: 5, category_name: 'kiteboarding')
Tag.create(article_id: 4, category_id: 2, category_name: 'surfing')
Tag.create(article_id: 5, category_id: 4, category_name: 'scubadiving')
Tag.create(article_id: 6, category_id: 1, category_name: 'longboarding')
Tag.create(article_id: 7, category_id: 1, category_name: 'longboarding')
Tag.create(article_id: 8, category_id: 1, category_name: 'longboarding')
Tag.create(article_id: 9, category_id: 1, category_name: 'longboarding')
